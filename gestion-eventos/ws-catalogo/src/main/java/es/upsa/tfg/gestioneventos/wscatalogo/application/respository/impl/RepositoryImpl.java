...
public class RepositoryImpl implements Repository
{
    ...
    public Recinto save(Recinto recinto) throws EventosAppException {
        return (recinto.getId_recinto() == null)? dao.insertRecinto(recinto) : dao.updateRecinto(recinto)
                                                                                  .orElseThrow(RecintoNotFoundException::new);
    }
    @Override
    public void removeRecintoById(String id) throws EventosAppException {
        dao.deleteRecinto(id);
    }
